...
/**
  \class Binary_t
  \ingroup Core
  \brief Binary numbers, bit manipulations, etc.

Classes representing binary numbers with 8, 16, 32 or 64 bits:
Binary8_t, Binary16_t, Binary32_t, Binary64_t
...
You can also impose the number of bits by calling String() with the required number.

__NOTA BENE:__ the number of bits affects only the representation of the number as
